...
# ─── UNINSTALL MODE ──────────────────────────────────────────────────────
if [ "$1" = "uninstall" ]; then
    echo "FluxLinux Pro: Uninstalling General Software Engineering Environment..."
    ...
    echo "FluxLinux Pro: General Software Engineering Environment Uninstalled."
    exit 0
fi
# ─── END UNINSTALL MODE ──────────────────────────────────────────────────
...
echo "FluxLinux Pro: Setting up General Software Engineering Environment..."
TARGET_USER="flux"
TARGET_GROUP=$(id -gn $TARGET_USER 2>/dev/null || echo "flux")

# 1. Install System Dependencies & C/C++ Stack
echo "FluxLinux Pro: Installing System Dependencies & C/C++ Tools..."
export DEBIAN_FRONTEND=noninteractive
...
echo "FluxLinux Pro: Installing Rust (via rustup)..."
if ! command -v rustup >/dev/null; then
    ...
    echo "FluxLinux Pro: Rust already installed."
fi
...
GO_VER="1.23.4"
if [ ! -d "$GO_ROOT" ]; then
    echo "FluxLinux Pro: Installing Go $GO_VER..."
    ...
    echo "FluxLinux Pro: Go already installed."
fi
...
echo "FluxLinux Pro: Installing Lazygit (for LunarVim)..."
...
# 5. Install Editors
echo "FluxLinux Pro: Installing Editors..."
...
echo "FluxLinux Pro: Checking VS Code..."
...
echo "FluxLinux Pro: Installing LunarVim..."
