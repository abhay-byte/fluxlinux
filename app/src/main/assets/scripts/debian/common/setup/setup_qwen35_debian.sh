...
# ─── UNINSTALL MODE ──────────────────────────────────────────────────────
if [ "$1" = "uninstall" ]; then
    echo "FluxLinux Pro: Uninstalling Qwen3.5-0.8B Model..."
    ...
    echo "FluxLinux Pro: Qwen3.5-0.8B Model Uninstalled."
    exit 0
fi
# ─── END UNINSTALL MODE ──────────────────────────────────────────────────
...
echo "FluxLinux Pro: Setting up Qwen3.5-0.8B Model..."
...
if [ ! -f "$MODEL_FILE" ]; then
    echo "FluxLinux Pro: Downloading Qwen3.5-0.8B Q4_0 (507 MB)..."
