...
ROOTFS = [
    ...
    ("distro_opensuse", "rootfs.opensuse", "opensuse", "opensuse_tumbleweed_rootfs.tar.xz", "bfadb150ede98afbf8c1cc48425c818f2069ab597c6b3c71407f8417f34b1bfb", 15 * 1024 * 1024, "openSUSE Tumbleweed aarch64 20251127 maintainer-supplied rootfs; source URL not recorded", None, "docs/plan/fedora-void-opensuse.md"),
    ...
    ("distro_kali", "rootfs.kali", "kali", "kali_2026_2_rootfs.tar.xz", "562696884422db47c19db561004b6981f9578677cb627ae3d716ad2979e8febe", 40 * 1024 * 1024, "Kali NetHunter minimal arm64 input, flattened for Flux; source filename recorded in release notes", "d6403a5da175df325611d23af4b92330856059c45454eced7f4cdf3ca6df2e4e", "docs/plan/ubuntu-kali-parrot-arch.md"),
    ("distro_parrot", "rootfs.parrot", "parrot", "parrot_7.2_rootfs.tar.xz", "fb9a58929ab0c790f5e1c03829a5fae481ec282c2dd23e24b174c3314818b55a", 30 * 1024 * 1024, "Parrot Security arm64 input, flattened for Flux; source filename recorded in release notes", "8a486c8635918de6cebc3b339265c4cea73cb9d73f709d56d98e487769f78582", "docs/plan/ubuntu-kali-parrot-arch.md"),
    ("distro_arch", "rootfs.arch", "archlinux", "archlinux_arm_rootfs.tar.xz", "fb5757ab558b420ca0a5bef3f5a6f9259d3456a3b37f60be052cf221d19de9ca", 40 * 1024 * 1024, "Arch Linux ARM aarch64 slim rootfs supplied to Flux; source URL not recorded", None, "docs/plan/ubuntu-kali-parrot-arch.md"),
]
